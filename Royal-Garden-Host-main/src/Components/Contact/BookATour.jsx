...
function BookATour() {
    ...
    const countryOptions = [
        { value: "Types", label: "Select Type" },
        { value: "Roomstay with Cottage", label: "Roomstay with Cottage" },
        { value: "Bedspace with Suites", label: "Bedspace with Suites" },
                ...
                <div className="row flex-row-reverse justify-content-center align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div>
                            ...
                            >
                                <h3 className="sec-title mb-30 text-capitalize">Book Now</h3>
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-12">
                                        <NiceSelect options={countryOptions} defaultValue="Select Type" />
